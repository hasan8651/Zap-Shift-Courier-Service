...
const services = [
  {
    ...
    description:
      "Same-day, next-day, and economy options with live tracking and SMS updates.",
  ...
  },
  {
    ...
    description:
      "Reliable, wide-area coverage with optimized routes and hub-to-hub transfers.",
  ...
  },
  {
    ...
    description:
      "Store, pick, pack, and dispatch with real-time inventory visibility.",
  ...
  },
  {
    ...
    title: "Parcel Return",
    description:
      "Hassle-free reverse logistics with doorstep pickup and tracking.",
        ...
        <div className="rounded-3xl bg-secondary text-neutral-content p-6 sm:p-8 ring-1 ring-neutral/20">
          ...
          <div className="text-center mb-6">
            ...
            <p className="mt-2 text-white">
              Express delivery, nationwide coverage, fulfillment, COD, and
              more—built for growth.
            </p>
          </div>
